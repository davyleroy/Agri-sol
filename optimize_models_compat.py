...
class ModelCompatibilityOptimizer:
    ...
    def create_optimized_model(self, crop_type: str, target_classes: List[str]) -> Optional[tf.keras.Model]:
        ...
        if crop_type == 'POTATOES':
            ...
            model_name = f"optimized_potato_model"
        elif crop_type == 'BEANS':
            input_shape = (224, 224, 3)
            model_name = f"optimized_bean_model"
        else:
            input_shape = (224, 224, 3)
    ...
    def get_target_classes(self, crop_type: str) -> List[str]:
        ...
        class_mapping = {
            ...
            'TOMATOES': ['Early_blight', 'Late_blight', 'Leaf_Mold', 'Septoria_leaf_spot', 'Spider_mites', 'Target_Spot', 'Healthy'],
